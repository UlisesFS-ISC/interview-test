...
const mapDispatchToProps = (dispatch) => {
    return {
        initiateCartCalls: (userName) => dispatch(CartActions.initiateCartCalls(userName)),
        removeCartItemCalls: (userName, productId, merchantId, price, quantity) =>
            dispatch(CartActions.removeCartItemCalls(userName, productId, merchantId, price, quantity)),
